    ...
    for i in range(0, len(trajectory)):
        ...
        for j in range(NUM_DRONES):
            try:
                ...
                if i < k:
                    env.sendRateCmd(thrust=45000, roll_rate=0, pitch_rate=0, yaw_rate=0, timestep=t)
                else:
                    env.sendRateCmd(thrust=45000, roll_rate=1.2, pitch_rate=0, yaw_rate=0, timestep=t)
            except:
                break
